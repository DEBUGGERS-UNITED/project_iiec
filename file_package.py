...
def yum_config():
    ...
    os.system(cp hello.repo /etc/yum.repos.d/ > check_config.txt 2> check_config.txt)
...
def yum_install(software):
    ...
    os.system('yum install {} > check_install.txt 2> check_install.txt'.format(software))
